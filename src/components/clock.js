...
import {SecondBar,HourBar,MinuteBar} from "./ClockBar";
import "./clock.css";
      ...
      <div>
        <div>
          ...
          >
            ...
            <title>clock</title>
            <circle className="cls-1" cx="148" cy="148" r="148" />
            <circle className="cls-2" cx="148" cy="148" r="117.5" />
            <circle className="cls-2" cx="148" cy="148" r="117.5" />
            <g className="cls-3">
              <path
            ...
            <MinuteBar/>
            <SecondBar />
            <circle class="cls-8" cx="148" cy="148" r="5"/>
